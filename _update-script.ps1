...
$PluginName = "questMaster"
$GitRepoUrl = "https://github.com/winters27/QuestMaster.git"
...
try {
    ...
    Write-Host "   QuestMaster Plugin Installer/Updater" -ForegroundColor Cyan
    Write-Host "================================================" -ForegroundColor Cyan
    Write-Host ""
    ...
    Write-Host "    3. Search for 'QuestMaster' and enable it" -ForegroundColor Gray
    Write-Host ""
