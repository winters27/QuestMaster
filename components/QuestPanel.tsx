...
function QuestRow({ row, showBar, tone }: { row: Row; showBar: boolean; tone?: "manual"; }) {
    ...
    return (
        <div className="qm-row">
            ...
            {/* A button beats a sentence telling you to go press a button somewhere else. */}
            {tone === "manual" && (
                <Button
                    size="xs"
                    variant="primary"
                    ...
                    : (
                        <>
                            ...
                            <Section
                                ...
                                showBar={false}
                                tone="manual"
                                note="These run as an Activity inside Discord: the game loads in Discord's own window and progress only counts while you actually play, so there is nothing to automate. Open the quest and hit Launch Quest."
                            />
